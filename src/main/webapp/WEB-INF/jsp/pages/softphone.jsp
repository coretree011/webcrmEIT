...
<!-- 	    	<select>
	    		<option id="notReady" class="softbtn small focus" href="javascript:ctiNotReady_Left();">이석</option>
	    		<option id="notReady" class="softbtn small focus" href="javascript:ctiNotReady_Rest();">휴식</option>
	    		<option id="notReady" class="softbtn small focus" href="javascript:ctiNotReady_Edu();">교육</option>
	    	</select> -->
	    	<a class="softbtn small focus" >이석<i class="icon-arrow1"></i></a>
			<div class="notReadyMenu">
		    ...
		    <td align="right" width="200px;"> 
	    		<label id="empInfo"> [<%= session.getAttribute("empNm") %>, <%= session.getAttribute("extensionNo") %>]</label>
      ...
      <tr>
        <td><input type="text" class="darkinput mini" name="sp_state" value="" style="width: 198px;"/></td>
        <td align="center"></td>
