	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		try {
			...
			*/
			...
			cell = row.createCell(1);
			cell.setCellValue(ivrCallList.getJSONObject(i).getString("regDate"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(2);
			cell.setCellValue(ivrCallList.getJSONObject(i).getString("regHms"));
			cell.setCellStyle(C_D_C_T_style);
			...
			cell = row.createCell(5);
			cell.setCellValue(ivrCallList.getJSONObject(i).getString("extensionNo"));
			cell.setCellStyle(C_N_R_T_style);
			...
			logger.debug("ivrCallList 다운로드 완료.");
